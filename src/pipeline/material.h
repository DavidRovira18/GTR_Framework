...
namespace SCN {
	...
	public:
		...
		bool planer_reflection;

		//textures
		Sampler textures[eTextureChannel::ALL];

		//ctors
		Material() : alpha_mode(NO_ALPHA), alpha_cutoff(0.5), color(1, 1, 1, 1), two_sided(false), roughness_factor(1), metallic_factor(0), planer_reflection(false) {
